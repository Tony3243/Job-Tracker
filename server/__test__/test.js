...
describe("Jobs API", () => {
    ...
    describe("GET/API/Jobs", () => {
        ...
        test("Check if each object in Array has the right properties", async () => {
            ...
            expect(arrayOfJobs.length > 0)
            const properties = arrayOfJobs.every((element) => {
                return element.id && element.company_name && element.job_title && element.application_status && element.application_date && element.notes;
            })
